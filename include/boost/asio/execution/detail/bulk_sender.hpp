...
#if !defined(BOOST_ASIO_HAS_DEDUCED_SET_VALUE_TRAIT)
...
#endif // !defined(BOOST_ASIO_HAS_DEDUCED_SET_VALUE_TRAIT)
...
#if !defined(BOOST_ASIO_HAS_DEDUCED_SET_DONE_TRAIT)
...
#endif // !defined(BOOST_ASIO_HAS_DEDUCED_SET_DONE_TRAIT)
