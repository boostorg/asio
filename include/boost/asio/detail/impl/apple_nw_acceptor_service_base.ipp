...
#ifndef BOOST_ASIO_DETAIL_IMPL_APPLE_NW_ACCEPTOR_SERVICE_BASE_IPP
#define BOOST_ASIO_DETAIL_IMPL_APPLE_NW_ACCEPTOR_SERVICE_BASE_IPP
...
boost::system::error_code apple_nw_acceptor_service_base::close(
    apple_nw_acceptor_service_base::base_implementation_type& impl,
...
boost::system::error_code apple_nw_acceptor_service_base::cancel(
    apple_nw_acceptor_service_base::base_implementation_type& impl,
    boost::system::error_code& ec)
{
  if (!is_open(impl))
...
boost::system::error_code apple_nw_acceptor_service_base::listen(
    apple_nw_acceptor_service_base::base_implementation_type& impl,
        ...
        if (connection)
        {
          if (std::shared_ptr<accept_queues> queues = weak_queues.lock())
          {
            ...
            else if (queues->pending_sync_ != 0)
            {
              ...
              queues->pending_sync_->set(boost::system::error_code(),
...
boost::system::error_code apple_nw_acceptor_service_base::do_open(
    apple_nw_acceptor_service_base::base_implementation_type& impl,
...
boost::system::error_code apple_nw_acceptor_service_base::do_assign(
    apple_nw_acceptor_service_base::base_implementation_type& impl,
...
boost::system::error_code apple_nw_acceptor_service_base::do_set_option(
    apple_nw_acceptor_service_base::base_implementation_type& impl,
    const void* option, void (*set_fn)(const void*,
      nw_parameters_t, nw_listener_t, boost::system::error_code&),
    boost::system::error_code& ec)
{
  if (!is_open(impl))
  {
...
boost::system::error_code apple_nw_acceptor_service_base::do_get_option(
...
boost::system::error_code apple_nw_acceptor_service_base::do_bind(
    apple_nw_acceptor_service_base::base_implementation_type& impl,
    ...
    boost::system::error_code& ec)
{
  ...
  if (!impl.accept_queues_->unclaimed_connections_.empty())
  {
    apple_nw_ptr<nw_connection_t> new_connection(
        BOOST_ASIO_MOVE_CAST(apple_nw_ptr<nw_connection_t>)(
    ...
    bool is_continuation, bool peer_is_open)
{
  ...
  if (peer_is_open)
  {
    op->set(boost::asio::error::already_open,
        apple_nw_ptr<nw_connection_t>());
    scheduler_.post_immediate_completion(op, is_continuation);
    return;
  }
...
#endif // BOOST_ASIO_DETAIL_IMPL_APPLE_NW_ACCEPTOR_SERVICE_BASE_IPP
