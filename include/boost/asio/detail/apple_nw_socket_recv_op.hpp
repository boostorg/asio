...
#ifndef BOOST_ASIO_DETAIL_APPLE_NW_SOCKET_RECV_OP_HPP
#define BOOST_ASIO_DETAIL_APPLE_NW_SOCKET_RECV_OP_HPP
...
{
public:
  BOOST_ASIO_DEFINE_HANDLER_PTR(apple_nw_socket_recv_op);
...
#endif // BOOST_ASIO_DETAIL_APPLE_NW_SOCKET_RECV_OP_HPP
